<?php
    ...
    define('SYSPATH', ROOTPATH . '/vendor/kohana/core/');
    ...
    Kohana::init(array('base_url'   => '/',
                       ...
                       'caching'    => true,
                       'expose'     => true,
                       'cache_dir'  => (defined('TMP_IN_DOMAIN') && TMP_IN_DOMAIN) ? DOMAINPATH . 'cache' : APPPATH . 'cache',));
    ...
    $mods['auth']     = MODPATH . 'auth'; // Basic authentication
    $mods['cache']    = MODPATH . 'cache'; // Caching with multiple backends
    $mods['database'] = MODPATH . 'database'; // Database access
    $mods['image']    = MODPATH . 'image'; // Image manipulation
    $mods['minion']   = MODPATH . 'minion'; // CLI Tasks
    $mods['orm']      = MODPATH . 'orm'; // Object Relationship Mapping
