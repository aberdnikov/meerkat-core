...
#kohana_error div.content { padding: 0 10px; overflow: hidden; margin:0}
...
<div id="kohana_error" class="debug">
    <h1><span class="type"><?php print $title;?></span></h1>
    <div class="value"><?php print Debug::vars($value);?></div>
	<div id="<?php echo $error_id ?>" class="content debug">
		<ol class="trace">
