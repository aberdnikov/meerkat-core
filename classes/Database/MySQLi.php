    ...
    class Database_MySQLi extends Database {
        ...
        public function connect() {
            ...
            try {
                ...
                //var_dump($this->_config['connection']);
                //exit();
        ...
        public function datatype($type) {
            ...
            (
                ...
                'bigint unsigned'           => array('type' => 'int',
                                                     'min'  => '0',
                ...
                'float unsigned'            => array('type' => 'float',
                                                     'min'  => '0'),
                'int unsigned'              => array('type' => 'int',
                                                     'min'  => '0',
                                                     'max'  => '4294967295'),
                'integer unsigned'          => array('type' => 'int',
                                                     'min'  => '0',
                                                     'max'  => '4294967295'),
                ...
                'mediumint'                 => array('type' => 'int',
                                                     'min'  => '-8388608',
                                                     'max'  => '8388607'),
                'mediumint unsigned'        => array('type' => 'int',
                                                     'min'  => '0',
                                                     'max'  => '16777215'),
                ...
                'smallint unsigned'         => array('type' => 'int',
                                                     'min'  => '0',
                                                     'max'  => '65535'),
                ...
                'tinyint'                   => array('type' => 'int',
                                                     'min'  => '-128',
                                                     'max'  => '127'),
                'tinyint unsigned'          => array('type' => 'int',
                                                     'min'  => '0',
                                                     'max'  => '255'),
        ...
        public function query($type, $sql, $as_object = false, array $params = null) {
            if ($type === Database::SELECT) {
                ...
                if (
                    ...
                    &&
                    (mb_strpos($sql, 'SHOW FULL COLUMNS') !== 0)
                    &&
        ...
        function random_replicate($type) {
            if ($type == Database::SELECT) {
                ...
                //если есть SLAVE
                if (count($replicates)) {
                    Database::$default = array_rand($replicates);
                }
            }
        }
